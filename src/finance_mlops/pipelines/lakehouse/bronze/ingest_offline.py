...
from finance_mlops.config.paths import LAKEHOUSE_BRONZE_DIR, SOURCE_OFFLINE_DIR
from finance_mlops.pipelines.common.utils.spark import get_spark

log = logging.getLogger(__name__)

# ── Path configuration ────────────────────────────────────────────────────────
OFFLINE_INPUT_DIR = str(SOURCE_OFFLINE_DIR)
BRONZE_OUTPUT_DIR = str(LAKEHOUSE_BRONZE_DIR)
