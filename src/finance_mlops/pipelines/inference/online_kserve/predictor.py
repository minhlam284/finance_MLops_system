...
from finance_mlops.config.paths import SERVING_ROOT

import boto3
import mlflow.xgboost
from fastapi import FastAPI, HTTPException

from finance_mlops.pipelines.training.constants import MODEL_NAME
from finance_mlops.pipelines.training.inference_contract import build_predictions, parse_instances_payload

log = logging.getLogger(__name__)

DEFAULT_SERVING_ROOT = Path(SERVING_ROOT) / MODEL_NAME
