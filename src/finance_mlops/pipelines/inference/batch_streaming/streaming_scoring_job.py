...
Run modes:
  - Standalone  : python -m finance_mlops.pipelines.inference.batch_streaming.streaming_scoring_job
...
from finance_mlops.config.paths import (
    LAKEHOUSE_BRONZE_DIR,
    LAKEHOUSE_CHECKPOINT_DIR,
    LAKEHOUSE_GOLD_DIR,
    MLRUNS_DIR as MLRUNS_PATH,
)
from finance_mlops.pipelines.training.constants import BLOCK_THRESHOLD, FEATURE_COLS, MODEL_NAME
from finance_mlops.pipelines.common.utils.spark import get_spark

log = logging.getLogger(__name__)

BRONZE_EVENTS_PATH = str(LAKEHOUSE_BRONZE_DIR / "events")
GOLD_FEATURES_PATH = str(LAKEHOUSE_GOLD_DIR / "feat_account_unified")
GOLD_SCORES_PATH = str(LAKEHOUSE_GOLD_DIR / "fraud_scores")
CHECKPOINT_PATH = str(LAKEHOUSE_CHECKPOINT_DIR / "fraud_scoring")
