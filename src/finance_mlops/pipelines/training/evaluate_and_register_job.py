...
Logic:
  ...
  5. Write a short evaluation report to `artifacts/reports/ml_eval_report.json`.
"""
...
from finance_mlops.config.paths import MLRUNS_DIR as MLRUNS_PATH, REPORTS_DIR
from finance_mlops.pipelines.training.constants import EXPERIMENT_NAME, MIN_PRAUC_THRESHOLD, MODEL_NAME
